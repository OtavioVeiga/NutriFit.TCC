...
public class LoginView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Sair_btn = new javax.swing.JToggleButton();
        Cadastro_btn = new javax.swing.JToggleButton();
        CadastroAluno_btn = new javax.swing.JToggleButton();
        Entrar_btn = new javax.swing.JToggleButton();
        ...
        setPreferredSize(new java.awt.Dimension(672, 490));
        ...
        gridBagConstraints.insets = new java.awt.Insets(60, 10, 80, 42);
        getContentPane().add(Sair_btn, gridBagConstraints);

        Cadastro_btn.setBackground(new java.awt.Color(153, 153, 153));
        Cadastro_btn.setFont(new java.awt.Font("Microsoft YaHei", 1, 14)); // NOI18N
        Cadastro_btn.setText("Cadastrar");
        Cadastro_btn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        gridBagConstraints.ipady = 14;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(60, 10, 80, 0);
        getContentPane().add(Cadastro_btn, gridBagConstraints);

        CadastroAluno_btn.setBackground(new java.awt.Color(153, 153, 153));
        CadastroAluno_btn.setFont(new java.awt.Font("Microsoft YaHei", 1, 14)); // NOI18N
        CadastroAluno_btn.setText("Cadastrar Aluno");
        CadastroAluno_btn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        CadastroAluno_btn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CadastroAluno_btnActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(60, 10, 80, 0);
        getContentPane().add(CadastroAluno_btn, gridBagConstraints);
    ...
    private javax.swing.JToggleButton CadastroAluno_btn;
    private javax.swing.JToggleButton Cadastro_btn;
    private javax.swing.JToggleButton Entrar_btn;
    private javax.swing.JToggleButton Sair_btn;
